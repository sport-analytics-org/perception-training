...
from court_training.detection.data import Target
...
class CourtDetector(nn.Module):
    ...
    def forward(self, images: Float[Tensor, "B 3 H W"], targets: list[Target] | None = None) -> dict:
